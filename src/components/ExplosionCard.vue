<template>
  <div
    ...
    :style="cardStyle"
  >
  <div v-if="explosion.emoji">{{ explosion.emoji }}</div>
    <h2 class="text-lg" font="black" m="2">{{ explosion.name || '忘记叫啥了' }}</h2>
    <small class="block" p="2" v-html="explosion.description || '说点什么好呢'"></small>
    <slot></slot>
  </div>
</template>
